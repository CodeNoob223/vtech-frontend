...
export default function Certified() {
    ...
    const getBlogs = async () => {
        ...
        try {
            const res = await axios.get(`http://${localhostIP}:3001/api/blog/certified`, {});
    ...
    return (
        <div className="relative">
            <Helmet>
                <title>{user._id && (user.notifications.length > 0) ? `(${user.notifications.length})` : ""} Certified</title>
