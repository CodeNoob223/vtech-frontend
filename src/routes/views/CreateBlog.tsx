...
export default function CreateBlog() {
    ...
    const handleUploadBlog = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
    ...
    const handleImageUpload = async (image: File, onSuccess: (url: string) => void, onError: (error: string) => void) => {
        ...
        navigate(`/edit/${res.data}`);
    }

    return (
        <div className="relative">
            <Helmet>
                <title>{(user.notifications.length > 0) ? `(${user.notifications.length})` : ""} Create a blog</title>
            </Helmet>
                    ...
                    <div className="lg:grid lg:grid-cols-[65%_33%] gap-x-[2%]">
                        ...
                        >
                            ...
                            <div className="w-full text-white03 text-sm sm:text-base">
                                ...
                                />
                                <div className="sm:flex flex-shrink-0 sm:mt-0 mt-4">
                                    {
                                        acceptTerm ?
                                            <Button
                                                iconPos="back"
                                                content={blogData._id ? "Update" : "Upload blog"}
                                                type="submit"
                                                icon="icon-Upload-file"
                                                myStyles="bg-primary overflow-hidden"
                                            /> :
                                            <Button
                                                iconPos="back"
                                                content={blogData._id ? "Update" : "Upload blog"}
                                                type="button"
                                                icon="icon-Upload-file"
                                                myStyles="bg-disable overflow-hidden"
                                            />
                                    }
                                    <div className="flex flex-shrink-0 sm:ml-4 sm:mt-0 mt-2 w-max h-max translate-y-[5px]">
                        ...
                        <div className="w-full mt-7 min-w-[258px] h-max lg:mt-0">
                            ...
                            <div className="relative w-full h-[40px] mb-5">
                                ...
                                />
                                <span
                                    className={`absolute medium-icon right-[16px] top-[8px] cursor-pointer icon-Content-copy text-background`}
                                    onClick={() => {
                            ...
                            <div className="relative w-full h-[40px] mb-5">
                                ...
                                />
                                <span
                                    className={`absolute medium-icon right-[16px] top-[8px] cursor-pointer icon-Close text-background`}
                                    onClick={() => {
                            ...
                            <div className="relative w-full h-[40px] mb-5">
                                ...
                                />
                                <span
                                    className={`absolute medium-icon right-[16px] top-[8px] icon-Search text-slate-300`}
                                ></span>
                            ...
                            <div className="w-full min-h-[60px] max-h-[400px] overflow-y-scroll bg-black rounded-sm pt-3 px-3">
